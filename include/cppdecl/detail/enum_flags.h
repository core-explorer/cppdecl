...
#define TYPENAMES_FLAG_OPERATORS(name_) TYPENAMES_FLAG_OPERATORS_CUSTOM(static, name_)

// Same, but works at class scope.
#define TYPENAMES_FLAG_OPERATORS_IN_CLASS(name_) TYPENAMES_FLAG_OPERATORS_CUSTOM(friend, name_)

// Same, but lets you specify a custom decl-specifier-seq.
#define TYPENAMES_FLAG_OPERATORS_CUSTOM(prefix_, name_) \
