...
int main()
{
    ...
    CheckParseSuccess("foo<true, false, nullptr>",               m_any, R"({type="{flags=[],quals=[],name={global_scope=false,parts=[{name="foo",targs=[expr[{flags=[],quals=[],name={global_scope=false,parts=[{name="true"}]}}],expr[{flags=[],quals=[],name={global_scope=false,parts=[{name="false"}]}}],expr[{flags=[],quals=[],name={global_scope=false,parts=[{name="nullptr"}]}}]]}]}}",name="{global_scope=false,parts=[]}"})");
    ...
    std::cout << d(typeid(std::array             <int, 42>   ::iterator      ).name()) << '\n'; //    int*                                                                                 |    int*                                                                                                                                                                            |    class std::_Array_iterator<int,42>
    std::cout << d(typeid(std::array             <int, 42>   ::const_iterator).name()) << '\n'; //    int const*                                                                           |    int const*                                                                                                                                                                      |    class std::_Array_const_iterator<int,42>
    std::cout << d(typeid(std::vector            <int>       ::iterator      ).name()) << '\n'; //    __gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int> > >          |    std::__1::__wrap_iter<int*>                                                                                                                                                     |    class std::_Vector_iterator<class std::_Vector_val<struct std::_Simple_types<int> > >
    std::cout << d(typeid(std::vector            <int>       ::const_iterator).name()) << '\n'; //    __gnu_cxx::__normal_iterator<int const*, std::vector<int, std::allocator<int> > >    |    std::__1::__wrap_iter<int const*>                                                                                                                                               |    class std::_Vector_const_iterator<class std::_Vector_val<struct std::_Simple_types<int> > >
    std::cout << d(typeid(std::deque             <int>       ::iterator      ).name()) << '\n'; //    std::_Deque_iterator<int, int&, int*>                                                |    std::__1::__deque_iterator<int, int*, int&, int**, long, 1024l>                                                                                                                 |    class std::_Deque_iterator<class std::_Deque_val<struct std::_Deque_simple_types<int> > >
    std::cout << d(typeid(std::deque             <int>       ::const_iterator).name()) << '\n'; //    std::_Deque_iterator<int, int const&, int const*>                                    |    std::__1::__deque_iterator<int, int const*, int const&, int const* const*, long, 1024l>                                                                                         |    class std::_Deque_const_iterator<class std::_Deque_val<struct std::_Deque_simple_types<int> > >
    std::cout << d(typeid(std::forward_list      <int>       ::iterator      ).name()) << '\n'; //    std::_Fwd_list_iterator<int>                                                         |    std::__1::__forward_list_iterator<std::__1::__forward_list_node<int, void*>*>                                                                                                   |    class std::_Flist_iterator<class std::_Flist_val<struct std::_Flist_simple_types<int> > >
    std::cout << d(typeid(std::forward_list      <int>       ::const_iterator).name()) << '\n'; //    std::_Fwd_list_const_iterator<int>                                                   |    std::__1::__forward_list_const_iterator<std::__1::__forward_list_node<int, void*>*>                                                                                             |    class std::_Flist_const_iterator<class std::_Flist_val<struct std::_Flist_simple_types<int> > >
    std::cout << d(typeid(std::list              <int>       ::iterator      ).name()) << '\n'; //    std::_List_iterator<int>                                                             |    std::__1::__list_iterator<int, void*>                                                                                                                                           |    class std::_List_iterator<class std::_List_val<struct std::_List_simple_types<int> > >
    std::cout << d(typeid(std::list              <int>       ::const_iterator).name()) << '\n'; //    std::_List_const_iterator<int>                                                       |    std::__1::__list_const_iterator<int, void*>                                                                                                                                     |    class std::_List_const_iterator<class std::_List_val<struct std::_List_simple_types<int> > >
    std::cout << d(typeid(std::set               <int>       ::iterator      ).name()) << '\n'; //    std::_Rb_tree_const_iterator<int>                                                    |    std::__1::__tree_const_iterator<int, std::__1::__tree_node<int, void*>*, long>                                                                                                  |    class std::_Tree_const_iterator<class std::_Tree_val<struct std::_Tree_simple_types<int> > >
    ...
    std::cout << d(typeid(std::map               <int, float>::iterator      ).name()) << '\n'; //    std::_Rb_tree_iterator<std::pair<int const, float> >                                 |    std::__1::__map_iterator<std::__1::__tree_iterator<std::__1::__value_type<int, float>, std::__1::__tree_node<std::__1::__value_type<int, float>, void*>*, long>>                |    class std::_Tree_iterator<class std::_Tree_val<struct std::_Tree_simple_types<struct std::pair<int const ,float> > > >
    std::cout << d(typeid(std::multimap          <int, float>::iterator      ).name()) << '\n'; //    std::_Rb_tree_iterator<std::pair<int const, float> >                                 |    std::__1::__map_iterator<std::__1::__tree_iterator<std::__1::__value_type<int, float>, std::__1::__tree_node<std::__1::__value_type<int, float>, void*>*, long>>                |    class std::_Tree_iterator<class std::_Tree_val<struct std::_Tree_simple_types<struct std::pair<int const ,float> > > >
    std::cout << d(typeid(std::map               <int, float>::const_iterator).name()) << '\n'; //    std::_Rb_tree_const_iterator<std::pair<int const, float> >                           |    std::__1::__map_const_iterator<std::__1::__tree_const_iterator<std::__1::__value_type<int, float>, std::__1::__tree_node<std::__1::__value_type<int, float>, void*>*, long>>    |    class std::_Tree_const_iterator<class std::_Tree_val<struct std::_Tree_simple_types<struct std::pair<int const ,float> > > >
    std::cout << d(typeid(std::multimap          <int, float>::const_iterator).name()) << '\n'; //    std::_Rb_tree_const_iterator<std::pair<int const, float> >                           |    std::__1::__map_const_iterator<std::__1::__tree_const_iterator<std::__1::__value_type<int, float>, std::__1::__tree_node<std::__1::__value_type<int, float>, void*>*, long>>    |    class std::_Tree_const_iterator<class std::_Tree_val<struct std::_Tree_simple_types<struct std::pair<int const ,float> > > >
    std::cout << d(typeid(std::unordered_set     <int>       ::iterator      ).name()) << '\n'; //    std::__detail::_Node_iterator<int, true, false>                                      |    std::__1::__hash_const_iterator<std::__1::__hash_node<int, void*>*>                                                                                                             |    class std::_List_const_iterator<class std::_List_val<struct std::_List_simple_types<int> > >
    std::cout << d(typeid(std::unordered_multiset<int>       ::iterator      ).name()) << '\n'; //    std::__detail::_Node_iterator<int, true, false>                                      |    std::__1::__hash_const_iterator<std::__1::__hash_node<int, void*>*>                                                                                                             |    class std::_List_const_iterator<class std::_List_val<struct std::_List_simple_types<int> > >
    std::cout << d(typeid(std::unordered_set     <int>       ::const_iterator).name()) << '\n'; //    std::__detail::_Node_const_iterator<int, true, false>                                |    std::__1::__hash_const_iterator<std::__1::__hash_node<int, void*>*>                                                                                                             |    class std::_List_const_iterator<class std::_List_val<struct std::_List_simple_types<int> > >
    std::cout << d(typeid(std::unordered_multiset<int>       ::const_iterator).name()) << '\n'; //    std::__detail::_Node_const_iterator<int, true, false>                                |    std::__1::__hash_const_iterator<std::__1::__hash_node<int, void*>*>                                                                                                             |    class std::_List_const_iterator<class std::_List_val<struct std::_List_simple_types<int> > >
    std::cout << d(typeid(std::unordered_map     <int, float>::iterator      ).name()) << '\n'; //    std::__detail::_Node_iterator<std::pair<int const, float>, false, false>             |    std::__1::__hash_map_iterator<std::__1::__hash_iterator<std::__1::__hash_node<std::__1::__hash_value_type<int, float>, void*>*>>                                                |    class std::_List_iterator<class std::_List_val<struct std::_List_simple_types<struct std::pair<int const ,float> > > >
    std::cout << d(typeid(std::unordered_multimap<int, float>::iterator      ).name()) << '\n'; //    std::__detail::_Node_iterator<std::pair<int const, float>, false, false>             |    std::__1::__hash_map_iterator<std::__1::__hash_iterator<std::__1::__hash_node<std::__1::__hash_value_type<int, float>, void*>*>>                                                |    class std::_List_iterator<class std::_List_val<struct std::_List_simple_types<struct std::pair<int const ,float> > > >
    std::cout << d(typeid(std::unordered_map     <int, float>::const_iterator).name()) << '\n'; //    std::__detail::_Node_const_iterator<std::pair<int const, float>, false, false>       |    std::__1::__hash_map_const_iterator<std::__1::__hash_const_iterator<std::__1::__hash_node<std::__1::__hash_value_type<int, float>, void*>*>>                                    |    class std::_List_const_iterator<class std::_List_val<struct std::_List_simple_types<struct std::pair<int const ,float> > > >
    std::cout << d(typeid(std::unordered_multimap<int, float>::const_iterator).name()) << '\n'; //    std::__detail::_Node_const_iterator<std::pair<int const, float>, false, false>       |    std::__1::__hash_map_const_iterator<std::__1::__hash_const_iterator<std::__1::__hash_node<std::__1::__hash_value_type<int, float>, void*>*>>                                    |    class std::_List_const_iterator<class std::_List_val<struct std::_List_simple_types<struct std::pair<int const ,float> > > >
    //                                                                                           |    ## NOTE: In unordered containers, the second-to-last bool is true for sets and       |    ## NOTE: All mentions of `long` here are replaced with `long long` on Windows! (Those are most probably `ptrdiff_t`.)                                                           |    ## NOTE: std::[unordered_]set<T>::[const_]iterator are all equal to `std::list<T>::const_iterator.
    ...
    // --- libstdc++
    // std::vector
    CheckRoundtrip("__gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int> > >             ", m_any, "std::vector<int, std::allocator<int>>::iterator",                 {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("__gnu_cxx::__normal_iterator<int const*, std::vector<int, std::allocator<int> > >       ", m_any, "std::vector<int, std::allocator<int>>::const_iterator",           {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("__gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int> > >       ::blah", m_any, "std::vector<int, std::allocator<int>>::iterator::blah",           {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("__gnu_cxx::__normal_iterator<int const*, std::vector<int, std::allocator<int> > > ::blah", m_any, "std::vector<int, std::allocator<int>>::const_iterator::blah",     {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("__gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int> > >             ", m_any, "std::vector<int>::iterator",                                      {}, cppdecl::SimplifyTypeNamesFlags::all);
    CheckRoundtrip("__gnu_cxx::__normal_iterator<int const*, std::vector<int, std::allocator<int> > >       ", m_any, "std::vector<int>::const_iterator",                                {}, cppdecl::SimplifyTypeNamesFlags::all);
    CheckRoundtrip("__gnu_cxx::__normal_iterator<int*, std::vector<int, std::allocator<int> > >       ::blah", m_any, "std::vector<int>::iterator::blah",                                {}, cppdecl::SimplifyTypeNamesFlags::all);
    CheckRoundtrip("__gnu_cxx::__normal_iterator<int const*, std::vector<int, std::allocator<int> > > ::blah", m_any, "std::vector<int>::const_iterator::blah",                          {}, cppdecl::SimplifyTypeNamesFlags::all);
    // std::deque
    CheckRoundtrip("std::_Deque_iterator<int, int&, int*>                                                   ", m_any, "std::deque<int>::iterator",                                       {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_Deque_iterator<int, int const&, int const*>                                       ", m_any, "std::deque<int>::const_iterator",                                 {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_Deque_iterator<int, int&, int*>             ::blah                                ", m_any, "std::deque<int>::iterator::blah",                                 {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_Deque_iterator<int, int const&, int const*> ::blah                                ", m_any, "std::deque<int>::const_iterator::blah",                           {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    // std::forward_list
    CheckRoundtrip("std::_Fwd_list_iterator<int>                                                            ", m_any, "std::forward_list<int>::iterator",                                {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_Fwd_list_const_iterator<int>                                                      ", m_any, "std::forward_list<int>::const_iterator",                          {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_Fwd_list_iterator<int>       ::blah                                               ", m_any, "std::forward_list<int>::iterator::blah",                          {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_Fwd_list_const_iterator<int> ::blah                                               ", m_any, "std::forward_list<int>::const_iterator::blah",                    {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    // std::list
    CheckRoundtrip("std::_List_iterator<int>                                                                ", m_any, "std::list<int>::iterator",                                        {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_List_const_iterator<int>                                                          ", m_any, "std::list<int>::const_iterator",                                  {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_List_iterator<int>       ::blah                                                   ", m_any, "std::list<int>::iterator::blah",                                  {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_List_const_iterator<int> ::blah                                                   ", m_any, "std::list<int>::const_iterator::blah",                            {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    // std::set, std::multiset, std::map, std::multimap
    CheckRoundtrip("std::_Rb_tree_const_iterator<int>                                                       ", m_any, "std::set<int>::const_iterator",                                   {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_Rb_tree_iterator<std::pair<int const, float> >                                    ", m_any, "std::map<int, float>::iterator",                                  {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_Rb_tree_const_iterator<std::pair<int const, float> >                              ", m_any, "std::map<int, float>::const_iterator",                            {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_Rb_tree_const_iterator<int>                          ::blah                       ", m_any, "std::set<int>::const_iterator::blah",                             {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_Rb_tree_iterator<std::pair<int const, float> >       ::blah                       ", m_any, "std::map<int, float>::iterator::blah",                            {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::_Rb_tree_const_iterator<std::pair<int const, float> > ::blah                       ", m_any, "std::map<int, float>::const_iterator::blah",                      {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);

    CheckRoundtrip("std::__detail::_Node_iterator<int, true, false>                                         ", m_any, "std::unordered_set<int>::iterator",                               {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::__detail::_Node_const_iterator<int, true, false>                                   ", m_any, "std::unordered_set<int>::const_iterator",                         {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::__detail::_Node_iterator<std::pair<int const, float>, false, false>                ", m_any, "std::unordered_map<int, float>::iterator",                        {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::__detail::_Node_const_iterator<std::pair<int const, float>, false, false>          ", m_any, "std::unordered_map<int, float>::const_iterator",                  {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::__detail::_Node_iterator<std::pair<int const, float>, true, false>                 ", m_any, "std::unordered_set<std::pair<const int, float>>::iterator",       {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
    CheckRoundtrip("std::__detail::_Node_const_iterator<std::pair<int const, float>, true, false>           ", m_any, "std::unordered_set<std::pair<const int, float>>::const_iterator", {}, cppdecl::SimplifyTypeNamesFlags::bit_libstdcxx_normalize_iterators);
